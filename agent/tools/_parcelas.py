...
Port de agent/services/parcelas.py + valores_das_parcelas extraído de
agent/services/cadastrar.py. O módulo original não é alterado (remoção na T16).
"""
...
def valores_das_parcelas(valor_total: Decimal, parcela_total: int) -> list[Decimal]:
    """Divide valor_total em parcela_total parcelas iguais (Decimal).
    O resto (centavo) é absorvido pela última parcela."""
